...
hist_with_box('q84', 30, 5, 0.4, NULL, c(0,35), 'Number of Hours')
```
...
```{r, fig.height=3.5, fig.width=7}
hist_with_box('q85', 38, 6, 0.4, NULL, c(0,43), 'Number of Hours')
```
...
```{r}
hist_with_box('q86', 25, 4, 0.4, NULL, c(0,30), 'Days Per Month')
```
...
plot_frq(bns$q88, ylim=c(0,90)) + xlab('How Often') + ylab("Frequency")
```
</div>
...
plot_frq(bns$q89, ylim=c(0,80)) + xlab('') + ylab("Frequency")
```
</div>
