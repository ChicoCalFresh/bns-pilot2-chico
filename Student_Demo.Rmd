...
plot_frq(bns$academic_level,  ylim = c(0,120), wrap.labels = 8) + xlab('Class Standing') + 
  ylab("Frequency")
```
</div>
...
plot_frq(bns$q16, ylim=c(0,65), wrap.labels = 16, sort.frq = 'desc') + xlab('') + ylab("Frequency")
```
...
plot_frq(bns$q17,  ylim = c(0,60), wrap.labels = 8) + xlab('GPA') + ylab("Frequency")
```
</div>
...
plot_frq(bns$q18, type='histogram', show.prc = FALSE, show.n = FALSE, ylim = c(0,18)) +
