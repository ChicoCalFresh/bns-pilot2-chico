...
### Moderate Exercise
How often did you do **moderate-intensity** cardio or aerobic exercise (that caused a noticeable increase in heart rate, such as brisk walk) for at least 30 minutes? `r print_n_reporting("moderate_exercise_past_week")`
